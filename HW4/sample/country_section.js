country_section = function(p) {
    ...
    p.preload = function(){
        ...
        table6 = p.loadTable("indie_sorted.csv", "csv", "header");
        table7 = p.loadTable("rnb_sorted.csv", "csv", "header");
        table1 = p.loadTable("country_sorted.csv", "csv", "header");
        table2 = p.loadTable("eighties_sorted.csv", "csv", "header");
        table3 = p.loadTable("rock_sorted.csv", "csv", "header");

...
indie_section = function(p) {
    ...
    p.preload = function(){
        table4 = p.loadTable("metal_sorted.csv", "csv", "header");
        table5 = p.loadTable("pop_sorted.csv", "csv", "header");
        table1 = p.loadTable("indie_sorted.csv", "csv", "header");
        table2 = p.loadTable("rnb_sorted.csv", "csv", "header");
        table3 = p.loadTable("country_sorted.csv", "csv", "header");
        myFont = p.loadFont("HussarBdExt.otf")
...
//
//     p.preload = function(){
//         table3 = p.loadTable("metal_sorted.csv", "csv", "header");
//         table2 = p.loadTable("pop_sorted.csv", "csv", "header");
//         table1 = p.loadTable("indie_sorted.csv", "csv", "header");
//         table4 = p.loadTable("rnb_sorted.csv", "csv", "header");
//         table5 = p.loadTable("country_sorted.csv", "csv", "header");
...
var myp5 = new p5(indie_header, 'indie_header');


country_section = function(p) {
...
var myp5 = new p5(country_section, 'country_section');

country_header = function(p) {
    ...
    p.draw = function(){
        ...
        p.textFont(myFont);
        p.textSize(80);
        p.text("country", 30, 170);

    };

};

var myp5 = new p5(country_header, 'country_header');
...
var myp5 = new p5(rock_header, 'rock_header');

rock_section = function(p) {
    ...
    p.preload = function(){
        ...
        table2 = p.loadTable("indie_sorted.csv", "csv", "header");
        table3 = p.loadTable("rnb_sorted.csv", "csv", "header");
        table4 = p.loadTable("eighties_sorted.csv", "csv", "header");
        myFont = p.loadFont("HussarBdExt.otf")
...
//         p.textFont(myFont);
//         p.textSize(80);
//         p.text("eighties", 30, 170);
//
//     };
//
// };
//
// var myp5 = new p5(eighties_header, 'eighties_header');
//
// eighties_section = function(p) {
//
//     var canvaswidth = 1366;
//     var boxes = [];
//     var activeBoxNumber = "None";
...
//
//     p.preload = function(){
//         table5 = p.loadTable("rock_sorted.csv", "csv", "header");
...
// };
//
// var myp5 = new p5(eighties_section, 'eighties_section');
//

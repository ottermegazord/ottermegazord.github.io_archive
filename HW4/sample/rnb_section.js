...
rnb_section = function(p) {
    ...
    p.preload = function(){
        table3 = p.loadTable("metal_sorted1.csv", "csv", "header");
        table4 = p.loadTable("pop_sorted1.csv", "csv", "header");
        table5 = p.loadTable("indie_sorted1.csv", "csv", "header");
        table1 = p.loadTable("rnb_sorted1.csv", "csv", "header");
        table2 = p.loadTable("country_sorted1.csv", "csv", "header");

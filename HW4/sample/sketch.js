...
metal_section = function(p) {
    ...
    p.setup = function () {
        p.createCanvas(canvaswidth, 1000);
        p.background(100);
    ...
    p.draw = function(){
        ...
        p.cpalette(img_address);
        console.log(img_address);
        p.image(img, 0, 100, img.width, img.height);
        p.image(img2, 640, 100, img.width/2, img.height/2);
        p.image(img3, 640, 420, img.width/2, img.height/2);
        p.image(img4, 960, 100, img.width/2, img.height/2);
        p.image(img5, 960, 420, img.width/2, img.height/2);
    ...
    p.cpalette = function(img_address){
        ...
        p.fill(DV[0], DV[1], DV[2]);
        p.rect(0, 740, 256, 100);
        p.fill(V[0], V[1], V[2]);
        p.rect(256, 740, 256, 100);
        p.fill(M[0], M[1], M[2]);
        p.rect(512, 740, 256, 100);
        p.fill(LV[0], LV[1], LV[2]);
        p.rect(768, 740, 256, 100);
        p.fill(DM[0], DM[1], DM[2]);
        p.rect(1024, 740, 256, 100);

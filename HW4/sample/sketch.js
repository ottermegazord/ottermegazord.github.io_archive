...
rnb = function(p) {
    ...
    p.setup = function () {
        p.createCanvas(canvaswidth, 320);
        p.background(0);
        ...
        for (var i=0; i<=1293; i++) {
            ...
            boxes[i] = new p.Box(1.3*i + 413, 0, 15, 320, r, g, b, i);
        }
    ...
    p.draw = function(){
        ...
        p.image(img, 100, 0, img.width/2, img.height/2);
    ...
    p.cpalette = function(img_address){
        ...
        p.rect(0, 64, 150, 64);
        p.fill(M[0], M[1], M[2]);
        p.rect(0, 2*64, 150, 64);
        p.fill(LV[0], LV[1], LV[2]);
        p.rect(0, 3*64, 150, 64);
        p.fill(DM[0], DM[1], DM[2]);
        p.rect(0, 4*64, 150, 64);

...
var a = function( p ) {
    ...
    p.setup = function(){
        ...
        to = p.color(128, 0, 38);
        var canvas = p.createCanvas(500,300);
        ...
        longSlider.position(145 + xmargin, 110);
        longSlider.style('rotate', -90);
    ...
    p.draw = function(){
        ...
        var latString = "Latitude: " + lat.toFixed(6);
        var longString = "Longtitude: " + long.toFixed(6);
        ...
        p.rotate(p.HALF_PI * -1);
        p.text('Time', 100+10, 252);
        p.text('Latitude', 105, 220);

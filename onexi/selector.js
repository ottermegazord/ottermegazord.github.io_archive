var f = function (p) {
    ...
    p.setup = function(){
        ...
        m1 = p.loadImage('images/Allston.png');
        m2 = p.loadImage('images/Back Bay.png');
        m3 = p.loadImage('images/Bay Village.png');
        m4 = p.loadImage('images/Beacon Hill.png');
        m5 = p.loadImage('images/Brighton.png');
        m6 = p.loadImage('images/Charlestown.png');
        m7 = p.loadImage('images/Chinatown.png');
        m8 = p.loadImage('images/Dorchester.png');
        m9 = p.loadImage('images/Downtown.png');
        m10 = p.loadImage('images/East Boston.png');
        m11 = p.loadImage('images/Fenway.png');
        m12 = p.loadImage('images/Harbor Islands.png');
        m13 = p.loadImage('images/Hyde Park.png');
        m14 = p.loadImage('images/Jamaica Plain.png');
        m15 = p.loadImage('images/Leather District.png');
        m16 = p.loadImage('images/Longwood Medical Area.png');
        m17 = p.loadImage('images/Mattapan.png');
        m18 = p.loadImage('images/Mission Hill.png');
        m19 = p.loadImage('images/North End.png');
        m20 = p.loadImage('images/Roslindale.png');
        m21 = p.loadImage('images/Roxbury.png');
        m22 = p.loadImage('images/South Boston.png');
        m23 = p.loadImage('images/South Boston Waterfront.png');
        m24 = p.loadImage('images/South End.png');
        m25 = p.loadImage('images/West End.png');
        m26 = p.loadImage('images/West Roxbury.png');
